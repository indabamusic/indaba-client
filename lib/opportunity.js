...
module.exports = function(config) {
  ...
  Opportunity.prototype.getUrl = function() {
    if (this.competition_level === 'project') {
      return config.dorianEndpoint + "/projects/" + this.slug;
    } else {
      return config.dorianEndpoint + "/opportunities/" + this.slug;
    }
  };
  ...
  OpportunitySeries.prototype.getUrl = function() {
    return config.dorianEndpoint + '/opportunity-series/' + this.slug;
  };
